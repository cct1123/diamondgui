...
class NumericInput(dbc.InputGroup):
    ...
    def __init__(self, 
        ...
        placeholder="", disabled=False, persistence=True, 
        persistence_type="local", class_name="mb-3",
...
class UnitedInput(dbc.InputGroup):
    ...
    def __init__(self,
        ...
        unitdict={}, placeholder="", disabled=False, persistence=True, 
        persistence_type="local", class_name="mb-3", 
        ...
        self.children = [
            ...
            dcc.Store(id=id_store,storage_type="local", data=temp_data) # temporary solution to solve persistence failing problem (local persistence fails when there exists a callback that update the value)
        ]
    ...
    def _update_value_by_unit(self, unitoptions, unitvalue, min0, max0, step0, value0, datastore):
        ...
        if "input-" in input_id:
            ...
            if value0 != None:
                datastore = [unitoptions, 1.0, min0/prefactor, max0/prefactor, step0/prefactor, value0/prefactor]
            else:
                datastore[-1] = None
        else:
