...
layout_para = dbc.Col([
    ...
    dbc.Col([ 
        dbc.Row([
            ...
            dbc.Col([NumericInput("X Begin [nm]", -1E9, 1E9, 1, 50, id=ID+"input-X Begin")]),
            dbc.Col([NumericInput("X End [nm]", -1E9, 1E9, 1, 50, id=ID+"input-X End")]),
            dbc.Col([NumericInput("X Step [nm]", -1E9, 1E9, 1, 50, id=ID+"input-X Step")]),
        ...
        dbc.Row([
            ...
            dbc.Col([NumericInput("Y Begin [nm]", -1E9, 1E9, 1, 50, id=ID+"input-Y Begin")]),
            dbc.Col([NumericInput("Y End [nm]", -1E9, 1E9, 1, 50, id=ID+"input-Y End")]),
            dbc.Col([NumericInput("Y Step [nm]", -1E9, 1E9, 1, 50, id=ID+"input-Y Step")]),
        ]),
        dbc.Row([
            dbc.Col([
                dbc.InputGroup([
                    ...
                    dbc.Select(
                            ...
                            options=[
                                {"label": "1", "value": 1},
                                {"label": "2", "value": 2},
                                {"label": "3", "value": 3}, # refering to axis of the posiitioners
                            ],
                            value=3,
            ...
            dbc.Col([
                UnitedInput("Z Point", -1E9, 1E9, 1, 1000, "nm", L_DICT, id=ID+"input-Z Point"),
                ], width=8),
            ]),
    ]),
])
