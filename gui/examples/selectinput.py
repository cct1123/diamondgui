    ...
    def __init__(
        ...
        **group_args_optional,
        ...
        self.children = [
            ...
            dcc.Store(id=id_data_store, storage_type=persistence_type, data=value),
        ]
        super().__init__(
            self.children,
            id=self.id + "-base",
        ...
        callback(Output(id_data_store, "data"), Input(id_value, "value"))(
            self._store_value
        )
    ...
    def __init__(
        ...
        **group_args_optional,
        ...
        self.children = [
            ...
            dbc.InputGroupText(unit),
            dcc.Store(id=id_data_store, data=value),
        ]
...
if __name__ == "__main__":
    ...
    freq_input = UnitedInput("Freq", 3e9, 4e9, 1e6, 3.5e9, "Hz", id="freq")
