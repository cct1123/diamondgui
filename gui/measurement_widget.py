...
from components import NumericInput, UnitedInput
...
paramform = dbc.Container(
    [
        ...
        dcc.Store(
            id=id_temp_store, storage_type=persistence_type, data=[]
        ),  # store the parameters for future access
    ],
)
