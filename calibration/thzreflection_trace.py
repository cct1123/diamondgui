...
reflection is measured with a photodiode connected to the NIDAQmx. The
laser is not used in this measurement.
...
class THzReflectionTrace(Measurement):
    ...
    dataset = dict(zbd_time = np.array([]), zbd_amp = np.array([]))
